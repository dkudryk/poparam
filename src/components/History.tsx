      ...
      <div className="max-w-6xl mx-auto py-24 px-4 sm:pt-32 sm:pb-40 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="text-base text-gray-500 sm:text-xl lg:text-lg xl:text-xl">
            <p className="mb-8">
              Фонд був створений у червні 2021 року для підтримки талановитих
              танцівників України та надання можливостей для танцювального
              розвитку нашій талановитій молоді. За більш ніж пів року існування
              понад 150 дітей з усієї країни отримали танцювальний одяг та
              взуття, можливість брати участь у танцювальних заходах. Ми встигли
              заручитися підтримкою як спеціалізованих професійних брендів, так
              і багатьох клубів і міжнародної спільноти для привернення уваги до
              різноманітних потреб танцювального світу України.
            </p>
            <p>
